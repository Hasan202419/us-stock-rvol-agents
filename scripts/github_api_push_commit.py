...
DEFAULT_PATHS: tuple[str, ...] = (
    ...
    "agents/ibkr_market_data.py",
    "agents/symbol_filter.py",
    "agents/trader2b_universe.py",
    "agents/prop_scalp_rank.py",
    "data/trader2b_toro250.txt",
    "agents/scan_pipeline.py",
    "agents/scan_presets.py",
    ...
    "tests/test_telegram_scan_background.py",
    "tests/test_trader2b_universe.py",
    "tests/test_symbol_filter.py",
    "tests/test_scan_presets.py",
