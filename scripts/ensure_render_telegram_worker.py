...
_WORKER_ENV_KEYS: tuple[str, ...] = (
    ...
    "MTF_SNAPSHOT_ENABLED",
    "MTF_SNAPSHOT_STRATEGY_PASS_ONLY",
    "MTF_TIMEFRAMES",
    "MTF_LOOKBACK_CALENDAR_DAYS",
    "AMT_VWAP_SCALP_ENABLED",
    "AMT_RANK_BUY_FIRST",
    "AMT_SNAPSHOT_PASS_ONLY",
    "AMT_TIMEFRAME_MINUTES",
    "AMT_SESSION_LEN",
    "AMT_EMA_LEN",
    "AMT_LOOKBACK_CALENDAR_DAYS",
    "MARKET_SHIELD_ENABLED",
    "MARKET_SHIELD_SPY",
    "MARKET_SHIELD_QQQ",
    "MARKET_SHIELD_VIX",
    "MARKET_SHIELD_TIMEFRAME_MINUTES",
    "MARKET_SHIELD_MIN_SCORE_BULL",
    "MARKET_SHIELD_MIN_SCORE_NEUTRAL",
    "TELEGRAM_BABIR_AMT_IN_SCAN",
    "TELEGRAM_BABIR_MERGE_AMT_RANKED",
    "TELEGRAM_INTRADAY_YAHOO_FIRST",
    ...
    "TELEGRAM_APPEND_FRAMEWORKS",
    "LLM_ANALYST_FRAMEWORK_APPEND",
...
def _build_add_env() -> list[dict[str, str]]:
    ...
    forced_defaults = {
        ...
        "TELEGRAM_MAX_SYMBOLS": "1200",
        "TELEGRAM_MAX_SYMBOLS_ALL": "600",
        ...
        "TELEGRAM_APPEND_FRAMEWORKS": "false",
        "LLM_ANALYST_FRAMEWORK_APPEND": "true",
        "TELEGRAM_BABIR_AMT_IN_SCAN": "true",
        "TELEGRAM_BABIR_MERGE_AMT_RANKED": "true",
        "TELEGRAM_INTRADAY_YAHOO_FIRST": "false",
        "INTRADAY_YAHOO_BEFORE_POLYGON": "false",
        "TELEGRAM_AUTO_PUSH_USE_SCANALL": "false",
        "TELEGRAM_AUTO_PUSH_USE_TRADER2B": "true",
        "AMT_SNAPSHOT_PASS_ONLY": "false",
        ...
        "TELEGRAM_BOT_REPLY_TOP_N": "20",
        "TELEGRAM_AMT_BUY_TOP_N": "20",
        "TELEGRAM_AMT_NEAR_VAL_TOP_N": "15",
        "SCAN_MAX_WORKERS": "16",
        "TELEGRAM_SCAN_MAX_WORKERS": "16",
    }
